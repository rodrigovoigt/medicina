...
$(document).ready(function () {
    ...
    function atualizarTexto() {
        ...
        if ($('#estadoGeralSimples').is(':checked')) {
            textoGerado.push("Estado geral:\nBom estado geral, lúcido e orientado em tempo e espaço. Mucosas úmidas e normocoradas, anictérico, acianótico, afebril (SIC), deambulando sem auxílio, fácies atípicas, boas condições de higiene.\n");
        }

        if ($('#condicaoMental').is(':checked')) {
            textoGerado.push("Condição mental:\nColaborativo, memória e raciocínio preservados, normovigilante, humor eutímico e normobúlico com apetite e sono preservados.\n");
        }

        if ($('#capacidadeFisica').is(':checked')) {
            textoGerado.push("Capacidade física:\nEutrófico (IMC), com tônus e força preservados, normoativo. Normosfigmo, normotenso, eupneico, normoxemia em ar ambiente.\n");
        }
